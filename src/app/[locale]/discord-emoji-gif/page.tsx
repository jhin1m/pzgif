...
import rawContent from "@/content/discord-emoji-gif.json";
import { toolContent } from "@/lib/tools/content";
import { toolMetadata } from "@/lib/tools/metadata";
import { getRoute } from "@/lib/tools/registry";

/**
 * The dedicated emoji route. Same engine as the hub, no picker, and copy that
 * goes deep on the one thing that decides an emoji's weight: frame count.
 *
...
export default async function DiscordEmojiGifPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
