...
import rawContent from "@/content/discord-avatar-gif.json";
import { toolContent } from "@/lib/tools/content";
import { toolMetadata } from "@/lib/tools/metadata";
import { getRoute } from "@/lib/tools/registry";

/**
 * The dedicated avatar route. Discord publishes no byte limit for this
 * surface, and the page says so rather than borrowing the emoji figure the way
 * design-guidelines.md SS10 did.
 *
...
export default async function DiscordAvatarGifPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
