...
import rawContent from "@/content/crop-gif.json";
import { toolContent } from "@/lib/tools/content";
import { toolMetadata } from "@/lib/tools/metadata";
import { getRoute } from "@/lib/tools/registry";
import { CropGifTool } from "./crop-gif-tool";

/** The crop route. Server-rendered prose, one client island for the overlay. */
...
export default async function CropGifPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <>
      ...
      />
      <CropGifTool content={content} trustLine={<TrustLine />}>
