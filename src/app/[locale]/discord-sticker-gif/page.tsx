...
import rawContent from "@/content/discord-sticker-gif.json";
import { toolContent } from "@/lib/tools/content";
import { toolMetadata } from "@/lib/tools/metadata";
import { getRoute } from "@/lib/tools/registry";

/**
 * The dedicated sticker route. Its copy carries the five-second and
 * sixty-frame-per-second caps that neither locked document mentions and that
 * account for a great many refused uploads.
 *
...
const SLUG = "discord-sticker-gif";
...
export default async function DiscordStickerGifPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
